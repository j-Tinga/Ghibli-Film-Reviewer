...
## App Pages/Features
__Login Page__ - Landing page for when the app is initially open. (Username and password are currently static due to Firebase connection being discontinued, any valid text would do)
